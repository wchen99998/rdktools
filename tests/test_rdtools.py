...
try:
    ...
    pytest.skip("rdtools C++ extension not available", allow_module_level=True)
...
class TestBasicFunctions:
    ...
    def test_molecular_weights(self):
        ...
        weights = rdtools.molecular_weights(smiles)
...
class TestBatchOperations:
    ...
    def test_multiple_descriptors(self):
        ...
        results = rdtools.descriptors(smiles)
    ...
    def test_filter_valid(self):
        ...
        valid_smiles = rdtools.filter_valid(smiles)
...
class TestFingerprints:
    ...
    def test_morgan_fingerprints_parameters(self):
        ...
        fp_r1 = rdtools.morgan_fingerprints(smiles, radius=1, nbits=512)
        fp_r2 = rdtools.morgan_fingerprints(smiles, radius=2, nbits=512)
        ...
        fp_512 = rdtools.morgan_fingerprints(smiles, radius=2, nbits=512)
        fp_1024 = rdtools.morgan_fingerprints(smiles, radius=2, nbits=1024)
...
class TestInputValidation:
    ...
    def test_empty_array(self):
        ...
        weights = rdtools.molecular_weights(empty_smiles)
    ...
    def test_list_input(self):
        ...
        weights = rdtools.molecular_weights(smiles_list)
    ...
    def test_invalid_array_dimensions(self):
        ...
        with pytest.raises(ValueError, match="1-dimensional"):
            rdtools.molecular_weights(smiles_2d)
    ...
    def test_type_conversion(self):
        ...
        weights_obj = rdtools.molecular_weights(smiles_object)
        weights_uni = rdtools.molecular_weights(smiles_unicode)
...
class TestConsistency:
    ...
    def test_individual_vs_batch_descriptors(self):
        ...
        mw_individual = rdtools.molecular_weights(smiles)
        logp_individual = rdtools.logp(smiles)
        tpsa_individual = rdtools.tpsa(smiles)
        
        # Batch calculation
        batch_results = rdtools.descriptors(smiles)
